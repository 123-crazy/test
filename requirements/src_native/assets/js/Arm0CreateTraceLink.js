...
export let initStartItemList = function( data, ctx ) {
    ...
    if ( objectStrFromLocalStorage ) {
        ...
        if( updatedTraceLinkType && updatedTraceLinkType.dbValue ) {
            ...
            data.selectedTraceLinkType = updatedTraceLinkType.dbValue;
            data.traceLinkType.dbValue = updatedTraceLinkType.dbValue;
            data.traceLinkType.uiValue = updatedTraceLinkType.uiValue;
        }
...
export let traceLinkTypeUpdated = function( data ) {
    ...
    parentData.traceLinkType.dbValue = data.traceLinkType.dbValue;
    parentData.traceLinkType.uiValue = data.traceLinkType.uiValue;
