...
function _buildTreeTableColumnInfos(data) {
    ...
    awColumnInfos.push(awColumnSvc.createColumnInfo({
        name: 'object_name',
        displayName: data.i18n.objectName,
        width: 250,
        minWidth: 150,
        typeName: 'String',
    ...
    var sortCriteria = appCtxService.ctx.qualityChecklistManagerContext.sortCriteria;
...
export let processPWASelection = function (data, selectionModel) {
    ...
    var viewModelCollection = data.dataProviders.checklistTreeDataProvider.viewModelCollection;
...
/**
 * @memberof NgServices
 * @member Apm0ChecklistTreeService
 */
app.factory('Apm0ChecklistTreeService', () => exports);
