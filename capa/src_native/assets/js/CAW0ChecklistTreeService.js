 ...
 */
/**
 * @module js/CAW0ChecklistTreeService
 */
import app from 'app';
    ...
    if( !parentNode.isLeaf ) {
        ...
        var soaInput = {
            ...
            searchInput: {
                ...
                searchCriteria: {
                    objectSet: 'CAW0QualityChecklistsRel.WorkspaceObject',
 ...
 * @param {ViewModelObject} modifiedObjects
 */
...
/**
 * @memberof NgServices
 * @member CAW0ChecklistTreeService
 */
app.factory( 'CAW0ChecklistTreeService', () => exports );
