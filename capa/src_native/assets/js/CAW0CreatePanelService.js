 ...
 *
 * @module js/CAW0CreatePanelService
 */
import app from 'app';
...
export let getParentTask = function( selectedObj ) {
    if( isSchedule( selectedObj ) ) {
        ...
        if( selectedObj.props.task_type.dbValues[ 0 ] === '6' ) {
...
export let validateInput = function( targetTask ) {
    {
        ...
        } else if( targetTask.props.task_type.dbValues[ 0 ] === '6' ) {
...
export let getSecondaryObjForCreateRelations = function( data, ctx ) {
    ...
    if( data.selectedTab.panelId === 'CAW0CreatePanelSub' ) {
...
app.factory( 'CAW0CreatePanelService', () => exports );
