    ...
    if ( AWRequirementsEditor && Arm0Requirements ) {
        ...
        if ( editorId && version ) {
            ...
            if ( editor ) {
                ...
                } else if ( version === 'CKEDITOR_4' ) {
                    appCtxSvc.registerCtx( 'commentContext', false );
                    appCtxSvc.registerCtx( 'trackChanges', false );
                }
            }
        }
    }
 ...
 */
  export let updateMarkupContextForLoadedObjects = function( additionalMarkupData, deleteMarkupsForUids ) {
    ...
    if( reqMarkupCtx.serverReqMarkupsData ) {
