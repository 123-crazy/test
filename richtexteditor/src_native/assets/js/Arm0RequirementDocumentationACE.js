...
var _setViewerContent = function( data, htmlContent, ctx ) {
    ...
    if( requirementElement && requirementElement.length && requirementElement.length > 1 && ctx.splitView && ctx.splitView.mode === true && ctx.occmgmtContext && ctx.occmgmtContext2 && ctx.occmgmtContext.selectedModelObjects['0'].uid !== ctx.occmgmtContext2.selectedModelObjects['0'].uid ) {
