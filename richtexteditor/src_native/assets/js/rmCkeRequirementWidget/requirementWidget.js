...
export default class RequirementWidget extends CKEDITOR5.Plugin {
    ...
    _defineSchema() {
        ...
        schema.register( 'requirementHeader', {
            allowIn: 'requirement',
            allowAttributes: [ 'class', 'contenttype', 'selected', 'contenteditable', 'requirementNamePrefix', 'isDirty', 'isdirty' ],
            isLimit: true
        } );
    ...
    _defineTracelinkIconConversion() {
        ...
        conversion.for( 'downcast' ).add( dispatcher => dispatcher.on( 'insert:tracelinkicon', ( evt, data, conversionApi ) => {
                ...
                if( tracelinkIcon ) {
                    ...
                    const imgElement = viewWriter.createUIElement( 'img', { class: 'aw-base-icon aw-aria-border', src: imgSrc, alt: altText, tabIndex: 0 }, function( domDocument ) {
                        const domElement = this.toDomElement( domDocument );
