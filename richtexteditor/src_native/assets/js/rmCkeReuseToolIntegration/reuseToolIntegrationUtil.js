...
function createNavigateUp( viewWriter, editor ) {
    return viewWriter.createUIElement( 'faulticonup', { class: 'aw-ckeditor-header-element' }, function( domDocument ) {
        ...
        domElement.innerHTML = '<img class="aw-base-icon" style="width:16px;margin-top: 10%;" src="' + app.getBaseUrlPath() + '/image/miscChevronUp16.svg" alt="' + localTextBundle.faultIconUpTitle + '"/>';
...
function createNavigateDown( viewWriter, editor ) {
    return viewWriter.createUIElement( 'faulticondown', { class: 'aw-ckeditor-header-element' }, function( domDocument ) {
        const domElement = this.toDomElement( domDocument );
        domElement.innerHTML = '<img style="width:16px;margin-top: 10%;" src="' + app.getBaseUrlPath() + '/image/miscChevronDown16.svg" alt="' + localTextBundle.faultIconDownTitle + '"/>';
