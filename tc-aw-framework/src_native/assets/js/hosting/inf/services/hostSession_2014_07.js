        ...
        dms.loadObjects( uids ).then( function() {
            dms.getProperties( uids, [ 'object_string' ] ).then( function() {
                ...
                if( revRuleObj2 ) {
                    ...
                    let prop = uwPropertyService.createViewModelProperty( revRuleObj2.props.object_string.dbValues[0], revRuleObj2.props.object_string.uiValues[0], 'STRING', revRuleObj2.uid, revRuleObj2.props.object_string.uiValues );
                    let ctxUserSession = appCtxService.getCtx( 'userSession' );
                    ctxUserSession.props.awp0RevRule = prop;
                    appCtxService.updateCtx( 'userSession', ctxUserSession );
