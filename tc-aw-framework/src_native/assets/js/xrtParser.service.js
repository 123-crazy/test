 ...
 */
var _prepareSOAInput = function( type, targetPage, vmo, objectType, isStickyTab ) {
    var clientContexts = {};
 ...
 * @return the promise.
 */
export let getDeclStyleSheet = function( type, targetPage, vmo, objectType, isStickyTab ) {
    var inputData = _prepareSOAInput( type, targetPage, vmo, objectType, isStickyTab );
    if( !inputData ) {
        var deferred = AwPromiseService.instance.defer();
        return deferred.promise;
    }
 ...
 */
export let getXrtViewModel = function( type, targetPage, vmo, commandIds, isStickyTab ) {
    return exports.getDeclStyleSheet( type, targetPage, vmo, null, isStickyTab ).then(
        function( response ) {
