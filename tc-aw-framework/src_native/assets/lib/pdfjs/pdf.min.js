...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
        ...
        // ==== ACTIVE WORKSPACE (not a contribution) - remove 'build' subdirectory from path ====
...
};
{
  if (_is_node.isNodeJS && typeof require === "function") {
    ...
    // ==== ACTIVE WORKSPACE (not a contribution) - change filename to min version ====
...
class MessageHandler {
  ...
  _postMessage(message, transfers) {
    try {
      ...
      console.log('postMessage exception: ' + err);
    }
  }
...
class TextLayerRenderTask {
  ...
  cancel() {
    ...
    // ==== ACTIVE WORKSPACE (not a contribution) - do not throw this error
...
function validateRangeRequestCapabilities({
  ...
  // ==== ACTIVE WORKSPACE (not a contribution) - FMS may send 'x-fsc-identity-length' instead of 'Content-Length' ====
  if (!Number.isInteger(length)) {
      length = parseInt(getResponseHeader('x-fsc-identity-length'), 10);
  }
  ...
  // ==== ACTIVE WORKSPACE (not a contribution) - don't check 'Accept-Ranges' ====
