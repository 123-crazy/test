...
var _getAnyValueDisplayName = function() {
    var workflowLocalTextBundle = localeService.getLoadedText( app.getBaseUrlPath() + '/i18n/WorkflowCommandPanelsMessages' );
 ...
 *
 * @param {modelObject} modelObject input model object
...
/**
 * @method _processGroupMemberModelObject
 *
 ...
 *
 * @return {Object} locGroupMemberViewModelObj
 */
let _processGroupMemberModelObject = function( groupMemberViewModelObj ) {
    ...
    if( locGroupMemberViewModelObj ) {
        ...
        // This change is done as workaround to hide group and role properties for group member
        // and it will be reverted in later AW 6.1 cycle.
        locGroupMemberViewModelObj.cellProperties = {};
...
/**
 * @method _processUserModelObject
 *
...
/**
 * @method _processKeyRoleModelObject
 *
...
/**
 * @method _processResourcePoolModelObject
 *
 * This method handles view model object having 'ResourcePool' type.
 *
 * @param {Object} locResPoolViewModelObject: locResPoolViewModelObject
 *
...
let _processResourcePoolModelObject = function( resPoolViewModelObject ) {
    ...
    if( locResPoolViewModelObject ) {
        ...
        if( resourcePoolDispNameStr && resourcePoolDispNameStr.length > 0 ) {
            ...
            // This change is done as workaround to hide cellProperties for resource pool
            // and it will be reverted in later AW 6.1 cycle.
            locResPoolViewModelObject.cellProperties = {};
        }
...
/**
 * @method populateUserPanelCellData
 *
 ...
 *
 * @member Awp0UserPanelCellService
 */

export default exports = {
    populateUserPanelCellData
};
app.factory( 'Awp0UserPanelCellService', () => exports );
