...
export let collabSubscribeToConversation = function( object ) {
    ...
    var sublocation = appCtxService.getCtx( 'sublocation');
    var selectedObj = appCtxService.getCtx( 'selected' );
    if(  typeof sublocation !== 'undefined' && typeof selectedObj !== 'undefined' && (sublocation.clientScopeURI === 'Ac0CollaborationFeed' || sublocation.clientScopeURI === 'Ac0CollaborationActions' ) ) {
