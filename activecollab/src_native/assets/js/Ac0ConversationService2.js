...
export let doExpandDiscussionTile = function() {
    setTimeout( function() {
        var newConvObj = appCtxSvc.getCtx( 'newConvObj' );
        newConvObj.expandComments = true;
        appCtxSvc.registerCtx( 'newConvObj', newConvObj );
    }, 50 );
};

export let doCollapseDiscussionTile = function() {
    var newConvObj = appCtxSvc.getCtx( 'newConvObj' );
    newConvObj.expandComments = false;
    appCtxSvc.registerCtx( 'newConvObj', newConvObj );
};
...
export default exports = {
    ...
    doExpandDiscussionTile,
    doCollapseDiscussionTile
};
