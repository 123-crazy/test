...
export let getAsyncInput = function( data ) {
    ...
    if( data.brexIsSync !== undefined && data.brexIsSync.dbValue !== undefined ) {
        // radio button's true corresponds to "not async", false means "is async"
...
/**
 * Service to display Brex Validation panel.
 *
 * @member Ctm1BrexValidationService
 * @memberof NgServices
 */
app.factory( 'Ctm1BrexValidationService', () => exports );
