...
export let initializeContext = function( ctx ) {
    ...
    if( selectedObject ) {
        ...
        if( parentUnderlyingObject && parentUnderlyingObject.props.ctm0TopicTypeTagref ) {
            ...
            ctx.ctm1.parentObject = parentUnderlyingObject;
            ctx.ctm1.parentTopicType = parentTopicRef;
 ...
 */
export let getTopicTypeLov = function( ctx, allowMultiVersions ) {
...
{
    var topicType;
    topicType =  cdm.getObject( data.revision__ctm0TopicTypeTagref.dbValue);
    return topicType;
};
