...
let getNextSavedHandler = function( sourceObjects ) {
    let adapterConfigObject = cfgSvc.getCfgCached( 'saveHandlers' ).filter( i=>i.target.deps !== 'js/psEditSaveHandler' );
...
app.factory( 'psEditSaveHandler', () => exports );
