...
export let processSortTypeForVNC = function( sortingTypeForVNC ) {
    if( _appCtxSvc && _appCtxSvc.ctx && _appCtxSvc.ctx.preferences &&
        _appCtxSvc.ctx.preferences.AWC_Search_Filter_Values_Sort_Order && _appCtxSvc.ctx.preferences.AWC_Search_Filter_Values_Sort_Order[ '0' ] ) {
        sortingTypeForVNC = _appCtxSvc.ctx.preferences.AWC_Search_Filter_Values_Sort_Order[ '0' ];
    }
...
export let processSortTypeForVNCAscending = function( a, b ) {
    ...
    if( a && a.props && a.props.awp0CellProperties&& a.props.awp0CellProperties.dbValues[0] ) {

        let index1 = a.props.awp0CellProperties.dbValues[0].indexOf(':') + 1;
        value1 = a.props.awp0CellProperties.dbValues[0].substring(index1);
    }
    if( b && b.props && b.props.awp0CellProperties&& b.props.awp0CellProperties.dbValues[0] ) {

        let index2 = b.props.awp0CellProperties.dbValues[0].indexOf(':') + 1;
        value2 = b.props.awp0CellProperties.dbValues[0].substring(index2);
    }
