 ...
 */
export let updateAndReturnPlanTreeNodePosition = function( treeDataProvider, activeMove, movePlanObjectsInput ) {
    if( treeDataProvider.viewModelCollection && treeDataProvider.viewModelCollection.loadedVMObjects && treeDataProvider.viewModelCollection.loadedVMObjects.length > 0 ) {
        let selectedPlan = movePlanObjectsInput[ 0 ].plan;
...
/**
 * Program Planning move plan objects Service utility
 *
 * @memberof NgServices
 * @member MovePlanObjectsService
 */
app.factory( 'MovePlanObjectsService', () => exports );
