...
export let initTimelineWidget = function( ) {
    ...
    timelineManager.getGanttInstance().init( element.firstElementChild );
 ...
 */
export let pushInitialDataToTimeline = function() {
...
app.factory( 'PlanNavigationTimelineSync', () => exports );
