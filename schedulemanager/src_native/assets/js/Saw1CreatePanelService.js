...
export let checkAndSetBOConstantValue = function( data ) {
    soaSvc.ensureModelTypesLoaded( [ 'Schedule' ] ).then( function() {
        //Get Type Constant to hide Owning Project and Projects section
        var getTypeConstInput = [];
        //Get create input from constants map
        var creIType = cmm.getType( 'Schedule' );
        var createInputTypeName = creIType.constantsMap.CreateInput;
        ...
        constantsService.getTypeConstantValues( getTypeConstInput ).then( function( response ) {
