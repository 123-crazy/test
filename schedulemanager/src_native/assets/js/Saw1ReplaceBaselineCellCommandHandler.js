...
export let replaceBaseline = function( newBaseline, getBaselinesProvider, selectedBaselineProvider ) {
    ...
    //If none is selected and 2 baselines are there ,then from Baselines the last one is replaced
    else {
...
export let activateViewButton = function( data ){
 ...
 */
app.factory( 'Saw1ReplaceBaselineCellCommandHandler', () => exports );