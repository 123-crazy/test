 ...
 */
 ...
 let addNode = ( vmc, createdObjects )=>{
    for ( let index = 0; index < createdObjects.length; index++ ) {
        ...
        occmgmtStructureEditService.addChildNode( occurrenceInfo, childNdx, parentInfo );
    }
 };
    ...
    if( created && created.length ) {
        ...
        if( createdObjects.length ) {
            ...
            if( createdObjects.length > 1 ) {
                ...
                selectionElement = activeContext.rootElement.uid;
            }
        }
...
app.factory( 'cbaEditStructureService', () => exports );
