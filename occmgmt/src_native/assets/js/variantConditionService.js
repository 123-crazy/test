...
export let saveEditVCA2TableACE = function( data ) {
    ...
    let bomlinesToSplit = data.dirtyElements;
    ...
    occmgmtBackingObjectProviderService.getBackingObjects( appCtxSvc.ctx.mselected )
        ...
        .then( response=>{
            ...
            occmgmtBackingObjectProviderService.getBackingObjects( splitLines ).then( bomlines=>{
                ...
                eventSubscription = eventBus.subscribe( 'Pca0VariantConditionAuthoringGridViewModel.postProcessSetVariantExpressionData', ()=>{
...
app.factory( 'variantConditionService', () => exports );
